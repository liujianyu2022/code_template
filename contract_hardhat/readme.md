...
10. npx hardhat node                      启动一个本地的测试区块链，方便开发和测试。json-rpc: http://127.0.0.1:8545/  chainId: 31337
11. npx hardhat ignition deploy ./ignition/modules/Lock.ts

部署可以使用如下两种方式：
方式一：npx hardhat run ./scripts/deploy.ts                         （推荐）
方式二：npx hardhat ignition deploy ./ignition/modules/Lock.ts
